            ...
            onPressed: () {
              ...
              if (_formKey.currentState.validate()) {
                ...
                initDB.then((db) async {
                  await dbconn.insertProducto(
                    ProductoModel(nombre: productoName.text, precioUnitario: int.parse(productoprecio.text), costoUnitario: int.parse(productocosto.text), categoria: productocategoria.text, descripcion: productodescripcion.text)
                  );
                });
